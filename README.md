...
In its current state this bot is only capable of forwarding **text messages**, **polls**, **locations**, **photos** and
**documents**. Features below may be implemented in future iterations towards version 1.
