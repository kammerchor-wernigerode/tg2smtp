...
/**
 * A specialized {@link Downloader} for {@link Video Telegram video files}.
 *
 * @author Vincent Nadoll
 */
@RequiredArgsConstructor
public class VideoDownloader implements Downloader<Video> {
    ...
    @Override
    public Resource download(Video video) throws IOException {
        try {
